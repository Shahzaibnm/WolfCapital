...
contract WolfCapital6 is Initializable, OwnableUpgradeable {
...
function initialize(uint256 _feePercent) public initializer {
...
function updateTeam(address _user, uint256 _amount) private {
    ...
    function claimLottery() public {
        ...
        require(weeklyDeposits[msg.sender][currentWeek - 1] > 0,"No reward to Claim");

        uint256 userShare = (weeklyDeposits[msg.sender][currentWeek - 1] * percentDivider) /
            team.weeklyDeposits[currentWeek - 1];
        usdc.transfer(
            msg.sender,
    ...
    */
    ...
    function setDurations(uint256 _1, uint256 _2, uint256 _3, uint256 _4) external onlyOwner {
        timeStep = _1;
        claimDuration = _2;
    ...
    function setRequiredTeamAmount(uint256[10] memory _values) external onlyOwner {
    ...
    function setRequiredTeamUsers(uint256[10] memory _values) external onlyOwner {
    ...
    function changeFees(uint256 _1, uint256 _2, uint256 _3, uint256 _4, uint256 _5, uint256 _6) external onlyOwner{
        marketingFeePercent = _1;
        ownerFeePercent = _2;
        lotteryFeePercent = _3;
        dev1FeePercent = _4;
        dev2FeePercent = _5;
        dev3FeePercent = _6;
    }
